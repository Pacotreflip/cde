...
class AgregaComprobanteACierre
{
    /**
     * @var Material
     */
     ...
     */
    public function __construct(Cierre $cierre, UploadedFile $file, Thumbnail $thumbnail=null)
    {
        $this->cierre = $cierre;
        $this->file = $file;
    ...
    public function save()
    {
        ...
        $this->cierre->agregaComprobante($comprobante);
