...
Route::post('asignaciones/{id}', 'AsignacionesController@store')->name('asignaciones.store');
...
Route::get('asignar/destinos/{id_area}/{id_articulo}', 'AsignacionesController@getDestinos')->name('asignar.destinos');
