...
@foreach($entrega->comprobantes->chunk(3) as $comprobanteset)
    ...
    @foreach($comprobanteset as $comprobante)
      <div class="col-xs-4">
        <div class="foto thumbnail">
          ...
          <form action="{{ route('recepciones.comprobantes.delete', [$entrega, $comprobante]) }}" method="POST" accept-charset="UTF-8">
...
@unless(count($entrega->comprobantes))
  <div class="alert alert-info">Esta entrega todavia no tiene comprobantes.</div>
@endunless