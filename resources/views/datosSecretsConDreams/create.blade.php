...
{!! Form::open(array('url' => 'datosSecretsConDreams')) !!}    
      <div class="row">
        ...
        <div class="form-group col-xs-3">
            ...
            {!! Form::number('cantidad_comprada', null, ['class' => 'form-control input-sm', 'step' => 'any']) !!}
        </div>
        <div class="form-group col-xs-3">
            <label for="recibidos_por_factura">recibidos_por_factura:</label>
            {!! Form::number('recibidos_por_factura', null, ['class' => 'form-control input-sm', 'step' => 'any']) !!}
        </div>
        <div class="form-group col-xs-3">
        ...
        <div class="form-group col-xs-3">
            ...
            {!! Form::number('precio', null, ['class' => 'form-control input-sm', 'step' => 'any']) !!}
        </div>
        <div class="form-group col-xs-3">
        ...
        <div class="form-group col-xs-3">
            ...
            {!! Form::number('importe_sin_iva', null, ['class' => 'form-control input-sm', 'step' => 'any']) !!}
        </div>
        <div class="form-group col-xs-3">
        ...
        <div class="form-group col-xs-3">
            ...
            {!! Form::number('pesos', null, ['class' => 'form-control input-sm', 'step' => 'any']) !!}
        </div>
        <div class="form-group col-xs-3">
            <label for="dolares">dolares:</label>
            {!! Form::number('dolares', null, ['class' => 'form-control input-sm', 'step' => 'any']) !!}
        </div>
        <div class="form-group col-xs-3">
            <label for="euros">euros:</label>
            {!! Form::number('euros', null, ['class' => 'form-control input-sm', 'step' => 'any']) !!}
        </div>
        <div class="form-group col-xs-3">
            <label for="consolidado_dolares">consolidado_dolares:</label>
            {!! Form::number('consolidado_dolares', null, ['class' => 'form-control input-sm', 'step' => 'any']) !!}
        </div>
        <div class="form-group col-xs-3">
        ...
        <div class="form-group col-xs-3">
            ...
            {!! Form::number('cantidad_comprada_dreams', null, ['class' => 'form-control input-sm', 'step' => 'any']) !!}
        </div>
        <div class="form-group col-xs-3">
            <label for="cantidad_recibida_dreams">cantidad_recibida_dreams:</label>
            {!! Form::number('cantidad_recibida_dreams', null, ['class' => 'form-control input-sm', 'step' => 'any']) !!}
        </div>
        <div class="form-group col-xs-3">
        ...
        <div class="form-group col-xs-3">
            ...
            {!! Form::number('precio_unitario_antes_descuento_dreams', null, ['class' => 'form-control input-sm', 'step' => 'any']) !!}
        </div>
        <div class="form-group col-xs-3">
            <label for="descuento_dreams">descuento_dreams:</label>
            {!! Form::number('descuento_dreams', null, ['class' => 'form-control input-sm', 'step' => 'any']) !!}
        </div>
        <div class="form-group col-xs-3">
            <label for="precio_unitario_dreams">precio_unitario_dreams:</label>
            {!! Form::number('precio_unitario_dreams', null, ['class' => 'form-control input-sm', 'step' => 'any']) !!}
        </div>
        <div class="form-group col-xs-3">
        ...
        <div class="form-group col-xs-3">
            ...
            {!! Form::number('importe_sin_iva_dreams', null, ['class' => 'form-control input-sm', 'step' => 'any']) !!}
        </div>
        <div class="form-group col-xs-3">
        ...
        <div class="form-group col-xs-3">
            ...
            {!! Form::number('pagado_dreams', null, ['class' => 'form-control input-sm', 'step' => 'any']) !!}
        </div>
        <div class="form-group col-xs-3">
        ...
        <div class="form-group col-xs-3">
            ...
            {!! Form::number('presupuesto', null, ['class' => 'form-control input-sm', 'step' => 'any']) !!}
        </div>
        <div class="form-group col-xs-3">
            <label for="pesos_dreams">pesos_dreams:</label>
            {!! Form::number('pesos_dreams', null, ['class' => 'form-control input-sm', 'step' => 'any']) !!}
        </div>
        <div class="form-group col-xs-3">
            <label for="dolares_dreams">dolares_dreams:</label>
            {!! Form::number('dolares_dreams', null, ['class' => 'form-control input-sm', 'step' => 'any']) !!}
        </div>
        <div class="form-group col-xs-3">
            <label for="euros_dreams">euros_dreams:</label>
            {!! Form::number('euros_dreams', null, ['class' => 'form-control input-sm', 'step' => 'any']) !!}
        </div>
        <div class="form-group col-xs-3">
            <label for="consolidacion_dolares_dreams">consolidacion_dolares_dreams:</label>
            {!! Form::number('consolidacion_dolares_dreams', null, ['class' => 'form-control input-sm', 'step' => 'any']) !!}
        </div>
        <div class="form-group col-xs-3">
            <label for="costo_x_habitacion_dreams">costo_x_habitacion_dreams:</label>
            {!! Form::number('costo_x_habitacion_dreams', null, ['class' => 'form-control input-sm', 'step' => 'any']) !!}
        </div>
        <div class="form-group col-xs-3">
            <label for="consolidado_banco_dreams">consolidado_banco_dreams:</label>
            {!! Form::number('consolidado_banco_dreams', null, ['class' => 'form-control input-sm', 'step' => 'any']) !!}
        </div>
        <div class="form-group col-xs-3">
            <label for="id_clasificacion">id_clasificacion:</label>
            {!! Form::number('id_clasificacion', null, ['class' => 'form-control input-sm', 'step' => 'any']) !!}
        </div>
        <div class="form-group col-xs-3">
  ...
  {!! Form::submit('Guardas datos', array('class' => 'btn btn-primary')) !!}
  {!! Form::close() !!}
@stop
