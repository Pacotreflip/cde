<div class="modal-dialog modal-lg">
  <div class="modal-content">
    ...
    <input type="hidden" name="faltante" value="{{ $compra->monto - $compra->totalProgramado() }}">
      ...
      <div class="row">
        <div class="col-md-6 col-sm-12">    
          ...
          <div class="form-group">
            ...
            <input type="number" class="form-control" value="{{ $compra->monto - $compra->totalProgramado() }}" name="monto">
          </div>
        </div>
        <div class="col-md-6 col-sm-12"> 
          <div class="form-group">
